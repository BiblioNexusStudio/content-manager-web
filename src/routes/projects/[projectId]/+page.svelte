...
{:then projectResponse}
    ...
    <div class="flex flex-col overflow-hidden xl:flex-row">
        <div class="px-4 xl:me-8">
            ...
            {#if projectResponse?.counts?.notStarted + projectResponse?.counts?.inProgress + projectResponse?.counts?.inCompanyReview + projectResponse?.counts?.inPublisherReview + projectResponse?.counts?.completed > 0}
