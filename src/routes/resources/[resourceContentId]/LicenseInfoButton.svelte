...
<div class="dropdown dropdown-top">
    <div tabindex="0" role="button" class="btn btn-ghost btn-sm text-gray-600 hover:bg-[#e6f7fc]">License Info</div>
    ...
    >
        ...
        {#if resourceContent.language.iso6393Code.toLowerCase() === 'eng' ? licenseInfo.showAdaptationNoticeForEnglish : licenseInfo.showAdaptationNoticeForNonEnglish}
            <div>
                ...
                {englishLicensesForAdaptation.map(({ name }) => name).join(' and ')}. "{licenseInfo.title}" is licensed
                under
